...
Thread.sleep(2000);
//result kisminda "“You successfully clicked an alert”" old.test edin
     WebElement sonucyaziElmenti=driver.findElement(By.xpath("//p[@id='result']"));
   String actualYaziElementin=sonucyaziElmenti.getText();
        String expectecYazi="You successfully clicked an alert";
    Assert.assertEquals(expectecYazi,actualYaziElementin);
    }
    @Test
    public void test2() throws InterruptedException {
        //2. butona tıklayın, uyarıdaki
        // Cancel(iptal) butonuna tıklayın ve result mesajının
        //“successfuly” icermedigini test edin.

        driver.get("https://the-internet.herokuapp.com/javascript_alerts");
        driver.findElement(By.xpath("//*[text()='Click for JS Confirm']")).click();
//alert uzerindeki mesaji yadidirin
...
String expectecMesaj="successfuly";
Assert.assertFalse(actualMesaj.contains(expectecMesaj));
    }
    @Test
  ...
  Thread.sleep(2000);
        ...
        System.out.println("#.Button Alert mesaji"+driver.switchTo().alert().getText());
        driver.switchTo().alert().sendKeys("Ramazan uckun");
        driver.switchTo().alert().accept();
        String actualYazi=driver.findElement(By.xpath("//p[@id='result']")).getText();
        String expectecMesaj="Ramazan uckun";
        Assert.assertTrue(actualYazi.contains(expectecMesaj));
    }
}
